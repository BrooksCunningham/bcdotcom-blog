...
Jekyll static blog hosted on GitHub Pages. The site lives entirely under the `docs/` directory. Theme is Minima v2.5.1 (pinned by `github-pages` gem) with layout overrides for GTM. Content covers CDN, security, networking, and web infrastructure topics.
...
- **docs/_layouts/default.html** — Overrides Minima's base layout to add GTM noscript tag after `<body>`
- **docs/_includes/head.html** — Overrides Minima's head to add GTM script tag
